  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full max-w-lg">
      <input
        ...
        className="flex-1 px-4 py-3 rounded-xl border border-navy/20 bg-white/80 backdrop-blur-sm text-navy placeholder:text-navy/40 focus:outline-none focus:ring-2 focus:ring-teal"
      />
      <button
        type="submit"
        disabled={status === "loading"}
        className="px-6 py-3 bg-teal text-white font-semibold rounded-xl hover:bg-teal/90 hover:shadow-lg transition-all duration-300 disabled:opacity-50 whitespace-nowrap cursor-pointer"
      >
        {status === "loading" ? "..." : cta}
      </button>
    </form>
